...
public class Usuario implements Serializable {
    ...
    public enum UserType{normal, gold, administrador;}
    
    private double limiteCreacionesEventos;
	...
	public double getLimiteCreacionesEventos() {
		return limiteCreacionesEventos;
	}

	public void setLimiteCreacionesEventos(double limiteCreacionesEventos) {
		this.limiteCreacionesEventos = limiteCreacionesEventos;
	}
